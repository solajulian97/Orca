...
internal static class Program
{
    ...
    public static void Main()
    {
		...
		Equal(0.0, FootprintFormatting.VolumeTextIntensity(0, 11000), "zero volume text intensity");
		Equal(1.0, FootprintFormatting.VolumeTextIntensity(11000, 11000), "maximum volume text intensity");
		Equal(Math.Sqrt(1000.0 / 11000.0), FootprintFormatting.VolumeTextIntensity(1000, 11000), "volume text uses gentle square-root scaling");
		Equal(0.0, FootprintFormatting.VolumeTextIntensity(1000, 0), "invalid volume text denominator");
		Equal(true, FootprintFormatting.IsDeltaEmphasis(150, 1000, 150, 15), "delta emphasis exact thresholds qualify");
		Equal(true, FootprintFormatting.IsDeltaEmphasis(-300, 1000, 150, 15), "negative delta emphasis qualifies symmetrically");
		Equal(false, FootprintFormatting.IsDeltaEmphasis(149, 500, 150, 15), "delta emphasis below absolute threshold rejected");
		Equal(false, FootprintFormatting.IsDeltaEmphasis(150, 2000, 150, 15), "delta emphasis below percentage threshold rejected");
		Equal(false, FootprintFormatting.IsDeltaEmphasis(0, 1000, 0, 0), "zero delta remains neutral");
		...
		Equal(true, FootprintFormatting.IntersectsBody(100.75, 101.0, 101.0, 100.0), "last bearish body row included");
		Equal(false, FootprintFormatting.IntersectsBody(99.75, 100.0, 100.0, 101.0), "lower wick row excluded");
		Equal(false, FootprintFormatting.IntersectsBody(101.0, 101.25, 100.0, 101.0), "upper wick row excluded");
		Equal(true, FootprintFormatting.IntersectsBody(99.875, 100.125, 100.0, 100.0), "doji containing row included");
		Equal(false, FootprintFormatting.IntersectsBody(100.125, 100.375, 100.0, 100.0), "doji adjacent row excluded");
