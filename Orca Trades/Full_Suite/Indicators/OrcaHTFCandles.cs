...
namespace NinjaTrader.NinjaScript
{
	...
	public class OrcaHTFVisibilityHotkeyConverter : StringConverter
	{
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class OrcaHTFCandles : Indicator
	{
		...
		[NinjaScriptProperty]
		[Display(Name = "Enable Visibility Hotkey", Description = "Lets the configured chart-focused hotkey show or hide HTF Candles without stopping its calculations.", Order = 1, GroupName = "Display Controls")]
		public bool EnableVisibilityHotkey { get; set; }

		[NinjaScriptProperty]
		[TypeConverter(typeof(OrcaHTFVisibilityHotkeyConverter))]
		[Display(Name = "Visibility Hotkey", Description = "Select or enter an exact chord such as Alt+H or Ctrl+Alt+H. Assign the same nonreserved chord to Step Profile to toggle both together; NinjaTrader reserves Alt+A.", Order = 2, GroupName = "Display Controls")]
