...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class OrcaStepProfile : Indicator
	{
		...
		private string BuildProfileStatisticsText(long totalVolume, long totalDelta, long maxCumulativeDelta, long minCumulativeDelta)
		{
			...
			if (ShowTotalDelta)
				text = AppendStatisticsToken(text, "D " + FormatSignedValue(totalDelta));
			if (ShowFinishDelta)
				text = AppendStatisticsToken(text, "FD " + FormatSignedValue(CalculateFinishDelta(totalDelta, maxCumulativeDelta, minCumulativeDelta)));
			if (ShowDeltaPercent)
			{
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public partial class Indicator : NinjaTrader.Gui.NinjaScript.IndicatorRenderBase
	{
		...
		public OrcaStepProfile OrcaStepProfile(StepProfileBasis stepBasis, StepSessionConfiguration sessionConfiguration, StepIntervalType stepInterval, StepVolumeAmountType stepVolumeAmount, StepVolumeResetAnchor volumeResetAnchor, int volumeTickCompression, bool useDynamicVolumeAggregation, double volumeDynamicAggregationMultiplier, int maxDynamicVolumeTicks, int deltaTickCompression, bool useDynamicAggregation, int deltaDynamicRowMinPixels, double dynamicAggregationMultiplier, int dynamicDeltaMinCompression, int dynamicDeltaMaxCompression, StepTradeSourceMode tradeSourceMode, bool rTHOnly, DateTime rTHStart, DateTime rTHEnd, bool dynamicProfileWidth, int fillSpacePercent, bool overrideNonRthWidthOnVolumeCharts, int nonRthFillSpacePercent, bool overrideRthWidthOnTimeCharts, int rthTimeFillSpacePercent, int historicalProfileWidthPx, int activeProfileWidthPx, int activeDeltaWidthPx, bool dynamicHistoricalDeltaWidth, int historicalDeltaFillPercent, int historicalDeltaWidthPx, int rightOffsetPx, int profileBarSpacingPx, bool mirrorProfiles, StepMirrorArrangement mirrorArrangement, StepMirrorArrangement activeMirrorArrangement, StepActiveUnmirroredLayout activeUnmirroredLayout, bool showActiveVolume, bool showHistoricalVolume, bool showActiveDelta, bool showHistoricalDelta, bool showPOC, bool showBlockSeparators, bool useGradient, int gradientSteps, float minBrightness, bool showValueArea, bool showVAColor, bool showVALines, int valueAreaPercent, float vALineThickness, StepVALineStyleEnum vALineStyle, float activeVolumeOpacity, float historicalVolumeOpacity, float activeDeltaOpacity, float historicalDeltaOpacity, bool useDeltaIntensityColoring, float deltaIntensityMinOpacity, bool showDeltaText, StepHistoricalDeltaTextMode historicalDeltaTextMode, int historicalDeltaTextMinValue, int historicalDeltaTextMinRowHeight, int historicalDeltaTextMinBarSpacing, bool revealHistoricalDeltaOnHover, int deltaTextMinThreshold, float deltaTextFontSize, bool showProfileStatistics, bool showActiveStatistics, bool showHistoricalStatistics, bool showTotalDelta, bool showFinishDelta, bool showDeltaPercent, bool showTotalVolume, int statisticsFontSize, bool showSessionLabels, bool enableVisibilityHotkey, string visibilityHotkey)
		{
			return OrcaStepProfile(Input, stepBasis, sessionConfiguration, stepInterval, stepVolumeAmount, volumeResetAnchor, volumeTickCompression, useDynamicVolumeAggregation, volumeDynamicAggregationMultiplier, maxDynamicVolumeTicks, deltaTickCompression, useDynamicAggregation, deltaDynamicRowMinPixels, dynamicAggregationMultiplier, dynamicDeltaMinCompression, dynamicDeltaMaxCompression, tradeSourceMode, rTHOnly, rTHStart, rTHEnd, dynamicProfileWidth, fillSpacePercent, overrideNonRthWidthOnVolumeCharts, nonRthFillSpacePercent, overrideRthWidthOnTimeCharts, rthTimeFillSpacePercent, historicalProfileWidthPx, activeProfileWidthPx, activeDeltaWidthPx, dynamicHistoricalDeltaWidth, historicalDeltaFillPercent, historicalDeltaWidthPx, rightOffsetPx, profileBarSpacingPx, mirrorProfiles, mirrorArrangement, activeMirrorArrangement, activeUnmirroredLayout, showActiveVolume, showHistoricalVolume, showActiveDelta, showHistoricalDelta, showPOC, showBlockSeparators, useGradient, gradientSteps, minBrightness, showValueArea, showVAColor, showVALines, valueAreaPercent, vALineThickness, vALineStyle, activeVolumeOpacity, historicalVolumeOpacity, activeDeltaOpacity, historicalDeltaOpacity, useDeltaIntensityColoring, deltaIntensityMinOpacity, showDeltaText, historicalDeltaTextMode, historicalDeltaTextMinValue, historicalDeltaTextMinRowHeight, historicalDeltaTextMinBarSpacing, revealHistoricalDeltaOnHover, deltaTextMinThreshold, deltaTextFontSize, showProfileStatistics, showActiveStatistics, showHistoricalStatistics, showTotalDelta, showFinishDelta, showDeltaPercent, showTotalVolume, statisticsFontSize, showSessionLabels, enableVisibilityHotkey, visibilityHotkey);
		}

		public OrcaStepProfile OrcaStepProfile(ISeries<double> input, StepProfileBasis stepBasis, StepSessionConfiguration sessionConfiguration, StepIntervalType stepInterval, StepVolumeAmountType stepVolumeAmount, StepVolumeResetAnchor volumeResetAnchor, int volumeTickCompression, bool useDynamicVolumeAggregation, double volumeDynamicAggregationMultiplier, int maxDynamicVolumeTicks, int deltaTickCompression, bool useDynamicAggregation, int deltaDynamicRowMinPixels, double dynamicAggregationMultiplier, int dynamicDeltaMinCompression, int dynamicDeltaMaxCompression, StepTradeSourceMode tradeSourceMode, bool rTHOnly, DateTime rTHStart, DateTime rTHEnd, bool dynamicProfileWidth, int fillSpacePercent, bool overrideNonRthWidthOnVolumeCharts, int nonRthFillSpacePercent, bool overrideRthWidthOnTimeCharts, int rthTimeFillSpacePercent, int historicalProfileWidthPx, int activeProfileWidthPx, int activeDeltaWidthPx, bool dynamicHistoricalDeltaWidth, int historicalDeltaFillPercent, int historicalDeltaWidthPx, int rightOffsetPx, int profileBarSpacingPx, bool mirrorProfiles, StepMirrorArrangement mirrorArrangement, StepMirrorArrangement activeMirrorArrangement, StepActiveUnmirroredLayout activeUnmirroredLayout, bool showActiveVolume, bool showHistoricalVolume, bool showActiveDelta, bool showHistoricalDelta, bool showPOC, bool showBlockSeparators, bool useGradient, int gradientSteps, float minBrightness, bool showValueArea, bool showVAColor, bool showVALines, int valueAreaPercent, float vALineThickness, StepVALineStyleEnum vALineStyle, float activeVolumeOpacity, float historicalVolumeOpacity, float activeDeltaOpacity, float historicalDeltaOpacity, bool useDeltaIntensityColoring, float deltaIntensityMinOpacity, bool showDeltaText, StepHistoricalDeltaTextMode historicalDeltaTextMode, int historicalDeltaTextMinValue, int historicalDeltaTextMinRowHeight, int historicalDeltaTextMinBarSpacing, bool revealHistoricalDeltaOnHover, int deltaTextMinThreshold, float deltaTextFontSize, bool showProfileStatistics, bool showActiveStatistics, bool showHistoricalStatistics, bool showTotalDelta, bool showFinishDelta, bool showDeltaPercent, bool showTotalVolume, int statisticsFontSize, bool showSessionLabels, bool enableVisibilityHotkey, string visibilityHotkey)
		{
			if (cacheOrcaStepProfile != null)
				for (int idx = 0; idx < cacheOrcaStepProfile.Length; idx++)
					if (cacheOrcaStepProfile[idx] != null && cacheOrcaStepProfile[idx].StepBasis == stepBasis && cacheOrcaStepProfile[idx].SessionConfiguration == sessionConfiguration && cacheOrcaStepProfile[idx].StepInterval == stepInterval && cacheOrcaStepProfile[idx].StepVolumeAmount == stepVolumeAmount && cacheOrcaStepProfile[idx].VolumeResetAnchor == volumeResetAnchor && cacheOrcaStepProfile[idx].VolumeTickCompression == volumeTickCompression && cacheOrcaStepProfile[idx].UseDynamicVolumeAggregation == useDynamicVolumeAggregation && cacheOrcaStepProfile[idx].VolumeDynamicAggregationMultiplier == volumeDynamicAggregationMultiplier && cacheOrcaStepProfile[idx].MaxDynamicVolumeTicks == maxDynamicVolumeTicks && cacheOrcaStepProfile[idx].DeltaTickCompression == deltaTickCompression && cacheOrcaStepProfile[idx].UseDynamicAggregation == useDynamicAggregation && cacheOrcaStepProfile[idx].DeltaDynamicRowMinPixels == deltaDynamicRowMinPixels && cacheOrcaStepProfile[idx].DynamicAggregationMultiplier == dynamicAggregationMultiplier && cacheOrcaStepProfile[idx].DynamicDeltaMinCompression == dynamicDeltaMinCompression && cacheOrcaStepProfile[idx].DynamicDeltaMaxCompression == dynamicDeltaMaxCompression && cacheOrcaStepProfile[idx].TradeSourceMode == tradeSourceMode && cacheOrcaStepProfile[idx].RTHOnly == rTHOnly && cacheOrcaStepProfile[idx].RTHStart == rTHStart && cacheOrcaStepProfile[idx].RTHEnd == rTHEnd && cacheOrcaStepProfile[idx].DynamicProfileWidth == dynamicProfileWidth && cacheOrcaStepProfile[idx].FillSpacePercent == fillSpacePercent && cacheOrcaStepProfile[idx].OverrideNonRthWidthOnVolumeCharts == overrideNonRthWidthOnVolumeCharts && cacheOrcaStepProfile[idx].NonRthFillSpacePercent == nonRthFillSpacePercent && cacheOrcaStepProfile[idx].OverrideRthWidthOnTimeCharts == overrideRthWidthOnTimeCharts && cacheOrcaStepProfile[idx].RthTimeFillSpacePercent == rthTimeFillSpacePercent && cacheOrcaStepProfile[idx].HistoricalProfileWidthPx == historicalProfileWidthPx && cacheOrcaStepProfile[idx].ActiveProfileWidthPx == activeProfileWidthPx && cacheOrcaStepProfile[idx].ActiveDeltaWidthPx == activeDeltaWidthPx && cacheOrcaStepProfile[idx].DynamicHistoricalDeltaWidth == dynamicHistoricalDeltaWidth && cacheOrcaStepProfile[idx].HistoricalDeltaFillPercent == historicalDeltaFillPercent && cacheOrcaStepProfile[idx].HistoricalDeltaWidthPx == historicalDeltaWidthPx && cacheOrcaStepProfile[idx].RightOffsetPx == rightOffsetPx && cacheOrcaStepProfile[idx].ProfileBarSpacingPx == profileBarSpacingPx && cacheOrcaStepProfile[idx].MirrorProfiles == mirrorProfiles && cacheOrcaStepProfile[idx].MirrorArrangement == mirrorArrangement && cacheOrcaStepProfile[idx].ActiveMirrorArrangement == activeMirrorArrangement && cacheOrcaStepProfile[idx].ActiveUnmirroredLayout == activeUnmirroredLayout && cacheOrcaStepProfile[idx].ShowActiveVolume == showActiveVolume && cacheOrcaStepProfile[idx].ShowHistoricalVolume == showHistoricalVolume && cacheOrcaStepProfile[idx].ShowActiveDelta == showActiveDelta && cacheOrcaStepProfile[idx].ShowHistoricalDelta == showHistoricalDelta && cacheOrcaStepProfile[idx].ShowPOC == showPOC && cacheOrcaStepProfile[idx].ShowBlockSeparators == showBlockSeparators && cacheOrcaStepProfile[idx].UseGradient == useGradient && cacheOrcaStepProfile[idx].GradientSteps == gradientSteps && cacheOrcaStepProfile[idx].MinBrightness == minBrightness && cacheOrcaStepProfile[idx].ShowValueArea == showValueArea && cacheOrcaStepProfile[idx].ShowVAColor == showVAColor && cacheOrcaStepProfile[idx].ShowVALines == showVALines && cacheOrcaStepProfile[idx].ValueAreaPercent == valueAreaPercent && cacheOrcaStepProfile[idx].VALineThickness == vALineThickness && cacheOrcaStepProfile[idx].VALineStyle == vALineStyle && cacheOrcaStepProfile[idx].ActiveVolumeOpacity == activeVolumeOpacity && cacheOrcaStepProfile[idx].HistoricalVolumeOpacity == historicalVolumeOpacity && cacheOrcaStepProfile[idx].ActiveDeltaOpacity == activeDeltaOpacity && cacheOrcaStepProfile[idx].HistoricalDeltaOpacity == historicalDeltaOpacity && cacheOrcaStepProfile[idx].UseDeltaIntensityColoring == useDeltaIntensityColoring && cacheOrcaStepProfile[idx].DeltaIntensityMinOpacity == deltaIntensityMinOpacity && cacheOrcaStepProfile[idx].ShowDeltaText == showDeltaText && cacheOrcaStepProfile[idx].HistoricalDeltaTextMode == historicalDeltaTextMode && cacheOrcaStepProfile[idx].HistoricalDeltaTextMinValue == historicalDeltaTextMinValue && cacheOrcaStepProfile[idx].HistoricalDeltaTextMinRowHeight == historicalDeltaTextMinRowHeight && cacheOrcaStepProfile[idx].HistoricalDeltaTextMinBarSpacing == historicalDeltaTextMinBarSpacing && cacheOrcaStepProfile[idx].RevealHistoricalDeltaOnHover == revealHistoricalDeltaOnHover && cacheOrcaStepProfile[idx].DeltaTextMinThreshold == deltaTextMinThreshold && cacheOrcaStepProfile[idx].DeltaTextFontSize == deltaTextFontSize && cacheOrcaStepProfile[idx].ShowProfileStatistics == showProfileStatistics && cacheOrcaStepProfile[idx].ShowActiveStatistics == showActiveStatistics && cacheOrcaStepProfile[idx].ShowHistoricalStatistics == showHistoricalStatistics && cacheOrcaStepProfile[idx].ShowTotalDelta == showTotalDelta && cacheOrcaStepProfile[idx].ShowFinishDelta == showFinishDelta && cacheOrcaStepProfile[idx].ShowDeltaPercent == showDeltaPercent && cacheOrcaStepProfile[idx].ShowTotalVolume == showTotalVolume && cacheOrcaStepProfile[idx].StatisticsFontSize == statisticsFontSize && cacheOrcaStepProfile[idx].ShowSessionLabels == showSessionLabels && cacheOrcaStepProfile[idx].EnableVisibilityHotkey == enableVisibilityHotkey && cacheOrcaStepProfile[idx].VisibilityHotkey == visibilityHotkey && cacheOrcaStepProfile[idx].EqualsInput(input))
						return cacheOrcaStepProfile[idx];
			return CacheIndicator<OrcaStepProfile>(new OrcaStepProfile(){ StepBasis = stepBasis, SessionConfiguration = sessionConfiguration, StepInterval = stepInterval, StepVolumeAmount = stepVolumeAmount, VolumeResetAnchor = volumeResetAnchor, VolumeTickCompression = volumeTickCompression, UseDynamicVolumeAggregation = useDynamicVolumeAggregation, VolumeDynamicAggregationMultiplier = volumeDynamicAggregationMultiplier, MaxDynamicVolumeTicks = maxDynamicVolumeTicks, DeltaTickCompression = deltaTickCompression, UseDynamicAggregation = useDynamicAggregation, DeltaDynamicRowMinPixels = deltaDynamicRowMinPixels, DynamicAggregationMultiplier = dynamicAggregationMultiplier, DynamicDeltaMinCompression = dynamicDeltaMinCompression, DynamicDeltaMaxCompression = dynamicDeltaMaxCompression, TradeSourceMode = tradeSourceMode, RTHOnly = rTHOnly, RTHStart = rTHStart, RTHEnd = rTHEnd, DynamicProfileWidth = dynamicProfileWidth, FillSpacePercent = fillSpacePercent, OverrideNonRthWidthOnVolumeCharts = overrideNonRthWidthOnVolumeCharts, NonRthFillSpacePercent = nonRthFillSpacePercent, OverrideRthWidthOnTimeCharts = overrideRthWidthOnTimeCharts, RthTimeFillSpacePercent = rthTimeFillSpacePercent, HistoricalProfileWidthPx = historicalProfileWidthPx, ActiveProfileWidthPx = activeProfileWidthPx, ActiveDeltaWidthPx = activeDeltaWidthPx, DynamicHistoricalDeltaWidth = dynamicHistoricalDeltaWidth, HistoricalDeltaFillPercent = historicalDeltaFillPercent, HistoricalDeltaWidthPx = historicalDeltaWidthPx, RightOffsetPx = rightOffsetPx, ProfileBarSpacingPx = profileBarSpacingPx, MirrorProfiles = mirrorProfiles, MirrorArrangement = mirrorArrangement, ActiveMirrorArrangement = activeMirrorArrangement, ActiveUnmirroredLayout = activeUnmirroredLayout, ShowActiveVolume = showActiveVolume, ShowHistoricalVolume = showHistoricalVolume, ShowActiveDelta = showActiveDelta, ShowHistoricalDelta = showHistoricalDelta, ShowPOC = showPOC, ShowBlockSeparators = showBlockSeparators, UseGradient = useGradient, GradientSteps = gradientSteps, MinBrightness = minBrightness, ShowValueArea = showValueArea, ShowVAColor = showVAColor, ShowVALines = showVALines, ValueAreaPercent = valueAreaPercent, VALineThickness = vALineThickness, VALineStyle = vALineStyle, ActiveVolumeOpacity = activeVolumeOpacity, HistoricalVolumeOpacity = historicalVolumeOpacity, ActiveDeltaOpacity = activeDeltaOpacity, HistoricalDeltaOpacity = historicalDeltaOpacity, UseDeltaIntensityColoring = useDeltaIntensityColoring, DeltaIntensityMinOpacity = deltaIntensityMinOpacity, ShowDeltaText = showDeltaText, HistoricalDeltaTextMode = historicalDeltaTextMode, HistoricalDeltaTextMinValue = historicalDeltaTextMinValue, HistoricalDeltaTextMinRowHeight = historicalDeltaTextMinRowHeight, HistoricalDeltaTextMinBarSpacing = historicalDeltaTextMinBarSpacing, RevealHistoricalDeltaOnHover = revealHistoricalDeltaOnHover, DeltaTextMinThreshold = deltaTextMinThreshold, DeltaTextFontSize = deltaTextFontSize, ShowProfileStatistics = showProfileStatistics, ShowActiveStatistics = showActiveStatistics, ShowHistoricalStatistics = showHistoricalStatistics, ShowTotalDelta = showTotalDelta, ShowFinishDelta = showFinishDelta, ShowDeltaPercent = showDeltaPercent, ShowTotalVolume = showTotalVolume, StatisticsFontSize = statisticsFontSize, ShowSessionLabels = showSessionLabels, EnableVisibilityHotkey = enableVisibilityHotkey, VisibilityHotkey = visibilityHotkey }, input, ref cacheOrcaStepProfile);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.OrcaStepProfile OrcaStepProfile(StepProfileBasis stepBasis, StepSessionConfiguration sessionConfiguration, StepIntervalType stepInterval, StepVolumeAmountType stepVolumeAmount, StepVolumeResetAnchor volumeResetAnchor, int volumeTickCompression, bool useDynamicVolumeAggregation, double volumeDynamicAggregationMultiplier, int maxDynamicVolumeTicks, int deltaTickCompression, bool useDynamicAggregation, int deltaDynamicRowMinPixels, double dynamicAggregationMultiplier, int dynamicDeltaMinCompression, int dynamicDeltaMaxCompression, StepTradeSourceMode tradeSourceMode, bool rTHOnly, DateTime rTHStart, DateTime rTHEnd, bool dynamicProfileWidth, int fillSpacePercent, bool overrideNonRthWidthOnVolumeCharts, int nonRthFillSpacePercent, bool overrideRthWidthOnTimeCharts, int rthTimeFillSpacePercent, int historicalProfileWidthPx, int activeProfileWidthPx, int activeDeltaWidthPx, bool dynamicHistoricalDeltaWidth, int historicalDeltaFillPercent, int historicalDeltaWidthPx, int rightOffsetPx, int profileBarSpacingPx, bool mirrorProfiles, StepMirrorArrangement mirrorArrangement, StepMirrorArrangement activeMirrorArrangement, StepActiveUnmirroredLayout activeUnmirroredLayout, bool showActiveVolume, bool showHistoricalVolume, bool showActiveDelta, bool showHistoricalDelta, bool showPOC, bool showBlockSeparators, bool useGradient, int gradientSteps, float minBrightness, bool showValueArea, bool showVAColor, bool showVALines, int valueAreaPercent, float vALineThickness, StepVALineStyleEnum vALineStyle, float activeVolumeOpacity, float historicalVolumeOpacity, float activeDeltaOpacity, float historicalDeltaOpacity, bool useDeltaIntensityColoring, float deltaIntensityMinOpacity, bool showDeltaText, StepHistoricalDeltaTextMode historicalDeltaTextMode, int historicalDeltaTextMinValue, int historicalDeltaTextMinRowHeight, int historicalDeltaTextMinBarSpacing, bool revealHistoricalDeltaOnHover, int deltaTextMinThreshold, float deltaTextFontSize, bool showProfileStatistics, bool showActiveStatistics, bool showHistoricalStatistics, bool showTotalDelta, bool showFinishDelta, bool showDeltaPercent, bool showTotalVolume, int statisticsFontSize, bool showSessionLabels, bool enableVisibilityHotkey, string visibilityHotkey)
		{
			return indicator.OrcaStepProfile(Input, stepBasis, sessionConfiguration, stepInterval, stepVolumeAmount, volumeResetAnchor, volumeTickCompression, useDynamicVolumeAggregation, volumeDynamicAggregationMultiplier, maxDynamicVolumeTicks, deltaTickCompression, useDynamicAggregation, deltaDynamicRowMinPixels, dynamicAggregationMultiplier, dynamicDeltaMinCompression, dynamicDeltaMaxCompression, tradeSourceMode, rTHOnly, rTHStart, rTHEnd, dynamicProfileWidth, fillSpacePercent, overrideNonRthWidthOnVolumeCharts, nonRthFillSpacePercent, overrideRthWidthOnTimeCharts, rthTimeFillSpacePercent, historicalProfileWidthPx, activeProfileWidthPx, activeDeltaWidthPx, dynamicHistoricalDeltaWidth, historicalDeltaFillPercent, historicalDeltaWidthPx, rightOffsetPx, profileBarSpacingPx, mirrorProfiles, mirrorArrangement, activeMirrorArrangement, activeUnmirroredLayout, showActiveVolume, showHistoricalVolume, showActiveDelta, showHistoricalDelta, showPOC, showBlockSeparators, useGradient, gradientSteps, minBrightness, showValueArea, showVAColor, showVALines, valueAreaPercent, vALineThickness, vALineStyle, activeVolumeOpacity, historicalVolumeOpacity, activeDeltaOpacity, historicalDeltaOpacity, useDeltaIntensityColoring, deltaIntensityMinOpacity, showDeltaText, historicalDeltaTextMode, historicalDeltaTextMinValue, historicalDeltaTextMinRowHeight, historicalDeltaTextMinBarSpacing, revealHistoricalDeltaOnHover, deltaTextMinThreshold, deltaTextFontSize, showProfileStatistics, showActiveStatistics, showHistoricalStatistics, showTotalDelta, showFinishDelta, showDeltaPercent, showTotalVolume, statisticsFontSize, showSessionLabels, enableVisibilityHotkey, visibilityHotkey);
		}

		public Indicators.OrcaStepProfile OrcaStepProfile(ISeries<double> input , StepProfileBasis stepBasis, StepSessionConfiguration sessionConfiguration, StepIntervalType stepInterval, StepVolumeAmountType stepVolumeAmount, StepVolumeResetAnchor volumeResetAnchor, int volumeTickCompression, bool useDynamicVolumeAggregation, double volumeDynamicAggregationMultiplier, int maxDynamicVolumeTicks, int deltaTickCompression, bool useDynamicAggregation, int deltaDynamicRowMinPixels, double dynamicAggregationMultiplier, int dynamicDeltaMinCompression, int dynamicDeltaMaxCompression, StepTradeSourceMode tradeSourceMode, bool rTHOnly, DateTime rTHStart, DateTime rTHEnd, bool dynamicProfileWidth, int fillSpacePercent, bool overrideNonRthWidthOnVolumeCharts, int nonRthFillSpacePercent, bool overrideRthWidthOnTimeCharts, int rthTimeFillSpacePercent, int historicalProfileWidthPx, int activeProfileWidthPx, int activeDeltaWidthPx, bool dynamicHistoricalDeltaWidth, int historicalDeltaFillPercent, int historicalDeltaWidthPx, int rightOffsetPx, int profileBarSpacingPx, bool mirrorProfiles, StepMirrorArrangement mirrorArrangement, StepMirrorArrangement activeMirrorArrangement, StepActiveUnmirroredLayout activeUnmirroredLayout, bool showActiveVolume, bool showHistoricalVolume, bool showActiveDelta, bool showHistoricalDelta, bool showPOC, bool showBlockSeparators, bool useGradient, int gradientSteps, float minBrightness, bool showValueArea, bool showVAColor, bool showVALines, int valueAreaPercent, float vALineThickness, StepVALineStyleEnum vALineStyle, float activeVolumeOpacity, float historicalVolumeOpacity, float activeDeltaOpacity, float historicalDeltaOpacity, bool useDeltaIntensityColoring, float deltaIntensityMinOpacity, bool showDeltaText, StepHistoricalDeltaTextMode historicalDeltaTextMode, int historicalDeltaTextMinValue, int historicalDeltaTextMinRowHeight, int historicalDeltaTextMinBarSpacing, bool revealHistoricalDeltaOnHover, int deltaTextMinThreshold, float deltaTextFontSize, bool showProfileStatistics, bool showActiveStatistics, bool showHistoricalStatistics, bool showTotalDelta, bool showFinishDelta, bool showDeltaPercent, bool showTotalVolume, int statisticsFontSize, bool showSessionLabels, bool enableVisibilityHotkey, string visibilityHotkey)
		{
			return indicator.OrcaStepProfile(input, stepBasis, sessionConfiguration, stepInterval, stepVolumeAmount, volumeResetAnchor, volumeTickCompression, useDynamicVolumeAggregation, volumeDynamicAggregationMultiplier, maxDynamicVolumeTicks, deltaTickCompression, useDynamicAggregation, deltaDynamicRowMinPixels, dynamicAggregationMultiplier, dynamicDeltaMinCompression, dynamicDeltaMaxCompression, tradeSourceMode, rTHOnly, rTHStart, rTHEnd, dynamicProfileWidth, fillSpacePercent, overrideNonRthWidthOnVolumeCharts, nonRthFillSpacePercent, overrideRthWidthOnTimeCharts, rthTimeFillSpacePercent, historicalProfileWidthPx, activeProfileWidthPx, activeDeltaWidthPx, dynamicHistoricalDeltaWidth, historicalDeltaFillPercent, historicalDeltaWidthPx, rightOffsetPx, profileBarSpacingPx, mirrorProfiles, mirrorArrangement, activeMirrorArrangement, activeUnmirroredLayout, showActiveVolume, showHistoricalVolume, showActiveDelta, showHistoricalDelta, showPOC, showBlockSeparators, useGradient, gradientSteps, minBrightness, showValueArea, showVAColor, showVALines, valueAreaPercent, vALineThickness, vALineStyle, activeVolumeOpacity, historicalVolumeOpacity, activeDeltaOpacity, historicalDeltaOpacity, useDeltaIntensityColoring, deltaIntensityMinOpacity, showDeltaText, historicalDeltaTextMode, historicalDeltaTextMinValue, historicalDeltaTextMinRowHeight, historicalDeltaTextMinBarSpacing, revealHistoricalDeltaOnHover, deltaTextMinThreshold, deltaTextFontSize, showProfileStatistics, showActiveStatistics, showHistoricalStatistics, showTotalDelta, showFinishDelta, showDeltaPercent, showTotalVolume, statisticsFontSize, showSessionLabels, enableVisibilityHotkey, visibilityHotkey);
		}
	}
