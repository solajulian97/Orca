...
public class BidPrice : MarketAnalyzerColumn
{
	protected override void OnStateChange()
	{
		...
		{
			((NinjaScript)this).Description = Resource.NinjaScriptMarketAnalyzerColumnDescriptionBidPrice;
			((NinjaScriptBase)this).Name = Resource.NinjaScriptMarketAnalyzerColumnNameBidPrice;
