...
public class LastPrice : MarketAnalyzerColumn
{
	protected override void OnStateChange()
	{
		...
		{
			((NinjaScript)this).Description = Resource.NinjaScriptMarketAnalyzerColumnDescriptionLastPrice;
			((NinjaScriptBase)this).Name = Resource.NinjaScriptMarketAnalyzerColumnNameLastPrice;
		...
		{
			((MarketAnalyzerColumnBase)this).CurrentValue = ((NinjaScriptBase)this).Instrument.MarketData.Last.Price;
		}
	}
