...
public class NetChangeMaxDown : MarketAnalyzerColumn
{
	...
	protected override void OnStateChange()
	{
		...
		{
			((NinjaScript)this).Description = Resource.NinjaScriptMarketAnalyzerColumnDescriptionNetChangeMaxDown;
			((NinjaScriptBase)this).Name = Resource.NinjaScriptMarketAnalyzerColumnNameNetChangeMaxDown;
	...
	protected override void OnMarketData(MarketDataEventArgs marketDataUpdate)
	{
		...
		if ((int)marketDataUpdate.MarketDataType == 4 && marketDataUpdate.Instrument.MarketData.LastClose != null)
		{
			num = marketDataUpdate.Price;
			num2 = marketDataUpdate.Instrument.MarketData.LastClose.Price;
		}
		else if ((int)marketDataUpdate.MarketDataType == 6 && marketDataUpdate.Instrument.MarketData.DailyLow != null)
		{
			num = marketDataUpdate.Instrument.MarketData.DailyLow.Price;
