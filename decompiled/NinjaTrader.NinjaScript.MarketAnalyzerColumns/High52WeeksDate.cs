...
public class High52WeeksDate : MarketAnalyzerColumn
{
	protected override void OnStateChange()
	{
		...
		{
			((NinjaScript)this).Description = Resource.NinjaScriptMarketAnalyzerColumnDescriptionHigh52WeeksDate;
			((NinjaScriptBase)this).Name = Resource.NinjaScriptMarketAnalyzerColumnNameHigh52WeeksDate;
		...
		else if ((int)((NinjaScript)this).State == 7 && ((NinjaScriptBase)this).Instrument != null && ((NinjaScriptBase)this).Instrument.FundamentalData != null && ((NinjaScriptBase)this).Instrument.FundamentalData.High52WeeksDate.HasValue)
		{
			((MarketAnalyzerColumnBase)this).CurrentValue = ((NinjaScriptBase)this).Instrument.FundamentalData.High52WeeksDate.Value.Subtract(Globals.MinDate).TotalDays;
	...
	protected override void OnFundamentalData(FundamentalDataEventArgs fundamentalDataUpdate)
	{
		...
		else if ((int)fundamentalDataUpdate.FundamentalDataType == 13)
		{
