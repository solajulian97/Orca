...
public class CalendarYearHighDate : MarketAnalyzerColumn
{
	protected override void OnStateChange()
	{
		...
		{
			((NinjaScript)this).Description = Resource.NinjaScriptMarketAnalyzerColumnDescriptionCalendarYearHighDate;
			((NinjaScriptBase)this).Name = Resource.NinjaScriptMarketAnalyzerColumnNameCalendarYearHighDate;
		...
		else if ((int)((NinjaScript)this).State == 7 && ((NinjaScriptBase)this).Instrument != null && ((NinjaScriptBase)this).Instrument.FundamentalData != null && ((NinjaScriptBase)this).Instrument.FundamentalData.CalendarYearHighDate.HasValue)
		{
			((MarketAnalyzerColumnBase)this).CurrentValue = ((NinjaScriptBase)this).Instrument.FundamentalData.CalendarYearHighDate.Value.Subtract(Globals.MinDate).TotalDays;
	...
	protected override void OnFundamentalData(FundamentalDataEventArgs fundamentalDataUpdate)
	{
		...
		else if ((int)fundamentalDataUpdate.FundamentalDataType == 3)
		{
