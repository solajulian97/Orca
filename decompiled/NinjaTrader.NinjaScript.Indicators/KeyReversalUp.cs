...
public class KeyReversalUp : Indicator
{
	...
	protected override void OnStateChange()
	{
		...
		{
			((NinjaScript)this).Description = Resource.NinjaScriptIndicatorDescriptionKeyReversalUp;
			((NinjaScriptBase)this).Name = Resource.NinjaScriptIndicatorNameKeyReversalUp;
	...
	protected override void OnBarUpdate()
	{
		...
		{
			((NinjaScriptBase)this).Value[0] = ((((NinjaScriptBase)this).Low[0] < ((NinjaScriptBase)min)[1] && ((NinjaScriptBase)this).Close[0] > ((NinjaScriptBase)this).Close[1]) ? 1 : 0);
		}
	}
}
